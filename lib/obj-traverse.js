...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.findAndDeleteAll = exports.findAndDeleteFirst = exports.findAndModifyAll = exports.findAndModifyFirst = exports.findAll = exports.findFirst = undefined;
	...
	exports.findFirst = _findFirst2.default;
	exports.findAll = _findAll2.default;
	exports.findAndModifyFirst = _findAndModifyFirst2.default;
	exports.findAndModifyAll = _findAndModifyAll2.default;
	exports.findAndDeleteFirst = _findAndDeleteFirst2.default;
	exports.findAndDeleteAll = _findAndDeleteAll2.default;
	...
	var findAndModifyFirst = function findAndModifyFirst(tree, childrenKey, objToFindBy, replacementObj) {
	  ...
	  if (found) {
	    ...
	    for (var _prop in replacementObj) {
	      reference[_prop] = replacementObj[_prop];
	    }
	  }
	...
	var findAndDeleteFirst = function findAndDeleteFirst(tree, childrenKey, objToFindBy) {
	  ...
	  function innerFunc(tree, childrenKey, objToFindBy) {
	    if (tree[childrenKey]) {
	      ...
	      for (var index = 0; index < tree[childrenKey].length; index++) {
